window.addEventListener("load", function () {
  ...
  if (isInstagram) {
    ...
    <div>
      ...
      <a href="https://wherestillhere.com" target="_blank" rel="noopener noreferrer" style="color: black; text-decoration: none; font-size: 25px; 
        background-color:white; border-radius: 12px; padding:5px 15px;">
